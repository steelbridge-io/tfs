...
<section id="two" class="wrapper alt style2">
	<section class="spotlight">
		...
		<?php
		if(get_post_meta(get_the_ID(), 'feature-pw1-checkbox', true) == 'yes') :?>
...
<!-- === SPOTLIGHT 2 SEASONS === -->
	<section class="spotlight">
		...
		<?php
		if(get_post_meta(get_the_ID(), 'feature-pw2-checkbox', true) == 'yes') :?>
		<div class="embed-responsive embed-responsive-16by9">
...
<!-- === SPOTLIGHT 3 FISHING SECTION === -->
		...
		<?php
		 // Fishing section
		if(get_post_meta(get_the_ID(), 'fishing-section-checkbox', true) == 'yes') :?>
		...
		<div class="image">
			...
			<?php
			if(get_post_meta(get_the_ID(), 'feature-pw3-checkbox', true) == 'yes') :?>
			<div class="embed-responsive embed-responsive-16by9">
		...
		<div class="panel-group" id="accordion-beat1">
			...
			<?php
			// Fishing beat #1
			if(get_post_meta(get_the_ID(), 'fishing-beat1-checkbox', true) == 'yes') :?>
			...
			<?php
			// Fishing beat #2
			if(get_post_meta(get_the_ID(), 'fishing-beat2-checkbox', true) == 'yes') :?>
			...
			<?php
			// Fishing beat #3
			if(get_post_meta(get_the_ID(), 'fishing-beat3-checkbox', true) == 'yes') :?>
			...
			<?php
			// Fishing beat #1
			if(get_post_meta(get_the_ID(), 'fishing-beat4-checkbox', true) == 'yes') :?>
			...
			<?php
			// Fishing beat #1
			if(get_post_meta(get_the_ID(), 'fishing-beat5-checkbox', true) == 'yes') :?>
			...
			<?php
			// Fishing beat #1
			if(get_post_meta(get_the_ID(), 'fishing-beat6-checkbox', true) == 'yes') :?>
...
<!-- === SPOTLIGHT #4 LODGING -->
	<section class="spotlight">
		...
		<div class="image">
			...
			if(get_post_meta(get_the_ID(), 'feature-pw4-checkbox', true) == 'yes') :?>
			<div class="embed-responsive embed-responsive-16by9">
	...
	<section class="spotlight">
		...
		<div class="image">
			<!-- Feature #3 Video/Text/Image Option -->
			<?php
			if(get_post_meta(get_the_ID(), 'feature-pw5-checkbox', true) == 'yes') :?>
			<div class="embed-responsive embed-responsive-16by9">
