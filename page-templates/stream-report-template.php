                ...
                <div class="panel-body">
                  <div class="panel-group" id="accordion-private" role="tablist" aria-multiselectable="true">
                    ...
                    <div class="panel panel-default">
                      ...
                      <div class="panel-heading accordion-toggle collapsed" role="tab" id="headingSeventeen" data-toggle="collapse" data-parent="#accordion-private" href="#collapseSeventeen" aria-expanded="true" aria-controls="collapseSeventeen">
                        <div class="row">
                          
                          <div class="col-sm-6">
                            <h4>Bailey Creek Lodge&nbsp;<a name="lowersac"></a><span class="arrow-down">Expand</span></h4>
                          </div>
                          
                          <div class="col-sm-6">
                            
                            <!-- === BEGIN EDIT SECTION: REPLACE 'label-default' with 'label-danger' to select any given rating === -->
                            <?php if(get_post_meta(get_the_ID(), 'baileycreek-closed-checkbox', true) == '-danger') :?>
                              <span class="label label-default<?php echo $baileycreek_closed_checkbox; ?>"><?php echo $baileycreek_closed_message; ?></span>
                            <?php else: ?>
                              <span class="label label-default<?php echo $baileycreek_checkbox_poor; ?>">Poor</span>
                              <span class="label label-default<?php echo $baileycreek_checkbox_fair; ?>">Fair</span>
                              <span class="label label-default<?php echo $baileycreek_checkbox_fairgood; ?>">Fair to Good</span>
                              <span class="label label-default<?php echo $baileycreek_checkbox_good; ?>">Good</span>
                              <span class="label label-default<?php echo $baileycreek_checkbox_great; ?>">Great</span>
                            <?php endif; ?>
                      ...
                      <div id="collapseSeventeen" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSeventeen">
                        <div class="report-panel">
                          <div id="baileycreekreport">
                            <div class="container-fluid">
                              <div class="row">
                                <div class="col-sm-6">
                                  <h4>Bailey Creek Lodge Report</h4>
                                </div>
                    ...
                    <div class="panel panel-default">
                      ...
                      <div class="panel-heading accordion-toggle collapsed" role="tab" id="headingTwentythree" data-toggle="collapse" data-parent="#accordion-private" href="#collapseThirty" aria-expanded="true" aria-controls="collapseThirty">
                        <div class="row">
                          
                          <div class="col-sm-6">
                            <h4>Pedrotti Ponds&nbsp;<a name="lowersac"></a><span class="arrow-down">Expand</span></h4>
                          </div>
                          
                          <div class="col-sm-6">
                            
                            <!-- === BEGIN EDIT SECTION: REPLACE 'label-default' with 'label-danger' to select any given rating === -->
                            <?php if(get_post_meta(get_the_ID(), 'pedrottiponds-closed-checkbox', true) == '-danger'):?>
                              <span class="label label-default<?php echo $pedrottiponds_closed_checkbox;?>"><?php echo $pedrottiponds_closed_message;?></span>
                            <?php else: ?>
                              <span class="label label-default<?php echo $pedrottiponds_checkbox_poor; ?>">Poor</span>
                              <span class="label label-default<?php echo $pedrottiponds_checkbox_fair; ?>">Fair</span>
                              <span class="label label-default<?php echo $pedrottiponds_checkbox_fairgood; ?>">Fair to Good</span>
                              <span class="label label-default<?php echo $pedrottiponds_checkbox_good; ?>">Good</span>
                              <span class="label label-default<?php echo $pedrottiponds_checkbox_great; ?>">Great</span>
                            <?php endif; ?>
                      ...
                      <div id="collapseThirty" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThirty">
                        <div class="report-panel">
                          <div id="pedrottipondsreport">
                            <div class="container-fluid">
                              <div class="row">
                                
                                <div class="col-sm-6">
                                  <h4>Pedrotti Ponds Report</h4>
                                </div>
