...
<section id="fishcamp-two" class="wrapper alt style2">
	<section class="spotlight">
		...
		<?php
		if(get_post_meta(get_the_ID(), 'feature-fc1-checkbox', true) == 'yes') :?>
...
<!-- ===  DATES === -->
	<section class="spotlight">
		...
		<?php
		if(get_post_meta(get_the_ID(), 'feature-fc2-checkbox', true) == 'yes') :?>
		<div class="embed-responsive embed-responsive-16by9">
		...
		<div class="content">
			...
			<div class="panel-group" id="accordiondates">
					...
					<?php
					// Dates read more
					if(get_post_meta(get_the_ID(), 'fishcamp-dates-readmore-checkbox', true) == 'yes') :?>
					...
					<h4 class="panel-title travel lodging-arrow">Read More&nbsp;<span class="arrow-down"></span></h4>
					</div>
...
<!-- === LODGING === -->
	<section class="spotlight">
		...
		<div class="image">
			...
			if(get_post_meta(get_the_ID(), 'feature-fc4-checkbox', true) == 'yes') :?>
			<div class="embed-responsive embed-responsive-16by9">
		...
		<div class="content">
			...
			<div class="travel"><?php echo $feature_4_fclodging_content;?></div>
				...
				<div class="panel-group" id="accordion4">
					...
					<?php
					// Read more option
					if(get_post_meta(get_the_ID(), 'fishcamp-lodging-readmore-checkbox', true) == 'yes') :?>
	...
	<section class="spotlight">
		...
		<div class="content">
			...
			<div class="travel"><?php echo $feature_fc5_get_to_content;?></div>
				...
				<div class="panel-group" id="accordion5">
					<div class="panel-travel fishcamp5">
						...
						<?php
						// Read more Option
						if(get_post_meta(get_the_ID(), 'fishcamp-gettingto-readmore-checkbox', true) == 'yes') :?>
		...
		<div class="image">
			...
			<?php
			if(get_post_meta(get_the_ID(), 'feature-fc5-checkbox', true) == 'yes') :?>
			<div class="embed-responsive embed-responsive-16by9">
			<iframe class="embed-responsive-item" src="<?php echo $video_fcfeature_five; ?>" allowfullscreen></iframe>
			</div>
			<?php else: ?>
		...
		<div class="content">
			...
			<div class="travel"><?php echo $feature_fcfive_textarea;?></div>
				...
				<div class="panel-group" id="accordionfive">
					<div class="panel-travel fishcamp3">
						...
						<?php
						// Readmore Option
						if(get_post_meta(get_the_ID(), 'fishcamp-itinerary-readmore-checkbox', true) == 'yes') :?>
