...
<section id="two" class="wrapper alt style2">
	<section class="spotlight">
		...
		<?php 
		if(get_post_meta(get_the_ID(), 'feature-gs1-checkbox', true) == 'yes') :?>
	...
	<section class="spotlight">
		...
		<?php 
		if(get_post_meta(get_the_ID(), 'feature-gs2-checkbox', true) == 'yes') :?>
		<div class="embed-responsive embed-responsive-16by9">
      ...
      <?php
      // Read more
      if(get_post_meta(get_the_ID(), 'guide-readmore-option-checkbox', true) == 'yes') :?>
      ...
      <div class="panel-group" id="accordion1">
        ...
        <?php
        // Spring Option
        if(get_post_meta(get_the_ID(), 'guide-optionspring-checkbox', true) == 'yes') :?>
        ...
        <?php
        // Summer Option
        if(get_post_meta(get_the_ID(), 'guide-optionsummer-checkbox', true) == 'yes') :?>
        ...
        <?php
        // Autumn option
        if(get_post_meta(get_the_ID(), 'guide-optionfall-checkbox', true) == 'yes') :?>
        ...
        <?php
        // WinterOption
        if(get_post_meta(get_the_ID(), 'guide-optionwinter-checkbox', true) == 'yes') :?>
	...
	<!-- === SPOTLIGHT 3 FISHING SECTION === -->
		...
		<div class="image">
			...
			<?php 
			if(get_post_meta(get_the_ID(), 'feature-gs3-checkbox', true) == 'yes') :?>
			<div class="embed-responsive embed-responsive-16by9">
		...
		<div class="panel-group" id="accordion-fishing-guide-readmore">
			<div class="panel-travel guidewaters_fishing4">
				...
				<?php
				// Read more
				if(get_post_meta(get_the_ID(), 'feature-gs3-fishing-readmore-checkbox', true) == 'yes') :?>
...
<!-- === GUIDED FISHING LODGING === -->
	<section class="spotlight">
		...
		<div class="image">
			...
			if(get_post_meta(get_the_ID(), 'feature-gs4-checkbox', true) == 'yes') :?>
			<div class="embed-responsive embed-responsive-16by9">
		...
		<div class="content">
			...
			<p class="travel"><?php echo $feature_4_gslodging_content;?></p>
				...
				<div class="panel-group" id="accordion4">
					...
					<?php
					// Readmore
					if(get_post_meta(get_the_ID(), 'feature-gs4-readmore-checkbox', true) == 'yes') :?>
	...
	<section class="spotlight">
		...
		<div class="image">
			...
			<?php 
			if(get_post_meta(get_the_ID(), 'feature-gs5-checkbox', true) == 'yes') :?>
			<div class="embed-responsive embed-responsive-16by9">
			...
			<p class="travel"><?php echo $feature_gs5_get_to_content;?></p>
				...
				<div class="panel-group" id="accordion5">
					<div class="panel-travel privatewaters5">
						...
						<?php
						// Readmore
						if(get_post_meta(get_the_ID(), 'feature-gs3-readmore-checkbox', true) == 'yes') :?>
