...
<article id="main">
    ...
    <section id="two" class="wrapper alt style2">
        <section class="spotlight">
            ...
            <div class="image">
                ...
                if(get_post_meta(get_the_ID(), 'feature-1-checkbox', true) == 'yes') :?>
            ...
            <div id="travel-style-one" class="content travel-template">
                ...
                <?php
                if(get_post_meta(get_the_ID(), 'rr-table-checkbox', true) == 'yes') :?>
                    <button type="button" class="table-btn btn btn-transparent" data-toggle="modal" data-target="
                    .travel-table-modal"><h4 class="panel-title travel travel-template table-h4">Click To Review Rates
                            &amp;
        ...
        <section class="spotlight">
            <div class="image">
                ...
                if(get_post_meta(get_the_ID(), 'feature-2-checkbox', true) == 'yes') :?>
                    <div class="embed-responsive embed-responsive-16by9">
            ...
            <div id="travel-style-two" class="content travel-template">
                ...
                <?php
                // Basic Season
                if(get_post_meta(get_the_ID(), 'basic-season-checkbox', true) == 'yes') :?>
                        ...
                        <div class="panel-group" id="accordion2">
                            <div class="panel-travel">
                                <div class="panel-heading accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion2" data-target="#collapseOne2">
                                    <h4 class="panel-title travel travel-template">Read More&nbsp;<span class="arrow-down"></span></h4>
                                </div>
        ...
        <section class="spotlight">
            <div class="image">
                ...
                if(get_post_meta(get_the_ID(), 'feature-3-checkbox', true) == 'yes') :?>
        ...
        <section class="spotlight">
            <div class="image">
                ...
                if(get_post_meta(get_the_ID(), 'feature-4-checkbox', true) == 'yes') :?>
                    <div class="embed-responsive embed-responsive-16by9">
        ...
        <section class="spotlight">
            ...
            <div class="image">
                ...
                if(get_post_meta(get_the_ID(), 'feature-5-checkbox', true) == 'yes') :?>
    ...
    <!-- ==== Set The Hook ==== -->
    <?php
    if(get_post_meta(get_the_ID(), 'setthehook-option-checkbox', true) == 'yes') : ?>
