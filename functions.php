...
function the_fly_shop_widgets_init() {
  ...
  register_sidebar( array(
    'name'          => esc_html__( 'Sidebar Lava Creek Lodge', 'the-fly-shop' ),
    'id'            => 'sidebar-6',
    'description'   => esc_html__( 'Add widgets here.', 'the-fly-shop' ),
    'before_widget' => '<section id="%1$s" class="widget %2$s">',
    'after_widget'  => '</section>',
...
function the_fly_shop_scripts() {
    ...
    wp_enqueue_style( 'the-fly-shop-main-style', get_template_directory_uri() . '/assets/css/sass/main.css', array(),  '20161116', 'all' );
